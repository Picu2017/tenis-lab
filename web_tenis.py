...
# --- PARCHE DE PERMISOS PARA MEDIA PIPE ---
# Redirigimos la búsqueda de modelos a /tmp para evitar el Permission Denied
...
try:
    # Usamos model_complexity=0 porque es el modelo que menos archivos externos pide
    ...
    st.info("Por favor, ve a 'Manage App' -> 'Reboot App' en el panel de Streamlit.")
    st.stop()
...
# Conexiones 13 puntos clave del tenista

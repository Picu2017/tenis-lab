...
# Obligamos a MediaPipe a usar /tmp para no chocar con las restricciones de la nube
...
@st.cache_resource
def get_pose_engine():
    # Usamos model_complexity=0 porque es el que menos archivos externos requiere
...
try:
    ...
    st.info("Intentando solución alternativa...")
    # Intento de carga sin cache si falla el anterior
...
# Esqueleto de 13 puntos (Optimizado para tenis)
CONEXIONES = [(11, 12), (11, 13), (13, 15), (12, 14), (14, 16), (11, 23), (12, 24), (23, 24), (23, 25), (25, 27), (24, 26), (26, 28)]



if uploaded_file is not None:
    # Guardamos en /tmp para asegurar permisos de lectura/escritura
